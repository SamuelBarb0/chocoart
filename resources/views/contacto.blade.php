      ...
      <div class="space-y-8">
        ...
        <div class="group relative">
          <div class="flex items-start gap-4">
            ...
            <div class="flex-1 pt-2">
              ...
              <p class="text-gray-600 leading-relaxed">Bogotá, Colombia<br>
              <span class="text-sm text-gray-500">Zona Norte - Detalles al contactar</span></p>
            </div>
          </div>
        </div>
          ...
          <div class="flex items-start gap-4">
            ...
            <div class="flex-1 pt-2">
              ...
              <p class="text-gray-600 leading-relaxed">
                <a href="https://wa.me/573001234567" class="hover:text-[var(--menta)] transition-colors">+57 300 123 4567</a><br>
                <span class="text-sm text-gray-500">Lun - Sáb: 9:00 AM - 6:00 PM</span>
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="group relative">
          <div class="flex items-start gap-4">
            ...
            <div class="flex-1 pt-2">
              ...
              <p class="text-gray-600 leading-relaxed">
                <a href="mailto:info@chocoart.com.co" class="hover:text-[var(--pistacho)] transition-colors">info@chocoart.com.co</a><br>
        ...
        <div class="pt-6 border-t-2 border-gray-100">
          ...
          <div class="flex justify-center gap-4">
            <a href="#" class="w-12 h-12 rounded-full bg-gradient-to-br from-[var(--rosa)] to-pink-300 flex items-center justify-center text-white hover:scale-110 transition-transform shadow-md">
              <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
            </a>
            <a href="#" class="w-12 h-12 rounded-full bg-gradient-to-br from-[var(--menta)] to-blue-300 flex items-center justify-center text-white hover:scale-110 transition-transform shadow-md">
            ...
            <a href="https://wa.me/573001234567" target="_blank" class="w-12 h-12 rounded-full bg-gradient-to-br from-[#25D366] to-[#128C7E] flex items-center justify-center text-white hover:scale-110 transition-transform shadow-md">
